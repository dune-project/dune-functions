...
\todograeser{Should we merge \cpp{LocalIndexSet} into \cpp{LocalView}?}
...
endlich streichen?}
\todograeser{Implement \cpp{treePath()} method in \dunemodule{dune-typetree}}
...
\todograeser{Describe in which sense the above bases behave in a standard way and
how to construct more complex ones.}
