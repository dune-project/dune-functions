...
of such spaces.
Let $B = \{\lambda_i\}_{i=1}^{n_1}$ and $C = \{\gamma_i\}_{i=1}^{n_2}$ be two scalar function space bases
...
(B,C)
 ...
 & =
 \big\{(\lambda_1,0), (\lambda_2,0), \dots, (\lambda_{n_1},0) \big\}
   \cup \big\{(0,\gamma_1), (0,\gamma_2), \dots, (0,\gamma_{n_2})\big\}.
\end{align*}
...
\label{eq:basis_product}
    (B,C)
 \colonequals
 \big\{(\lambda_1,\mathbf{0}), (\lambda_2,\mathbf{0}), \dots, (\lambda_{n_1},\mathbf{0})\big\}
 \cup
 \big\{(\mathbf{0}, \gamma_1), (\mathbf{0},\gamma_2), \dots, (\mathbf{0}, \gamma_{n_2})\big\}
\end{equation}
is the natural basis of the space $\operatorname{span} B \times \operatorname{span} C$.  Its basis functions take values in $\R^{r_1} \times \R^{r_2} = \R^{r_1+r_2}$.
...
\begin{center}
    \begin{tikzpicture}[
        ...
        \node [treenode] {$B$}
            ...
            child{ node [treenode] {$\gamma_3$} }
            child{ node [] {$\dots$} }
            child{ node [treenode] {$\gamma_{n-1}$} }
            child{ node [treenode] {$\gamma_n$} };
    \end{tikzpicture}
\end{center}
    ...
    \begin{center}
        \begin{tikzpicture}[
            ...
            \node [treenode] {$(P_2 \times P_2 \times P_2) \times P_1$}
                child{ node [treenode] {$P_2 \times P_2 \times P_2$}
                    child{ node [treenode] {$P_2$}
                        child{ node [basisnode] {$\lambda_1^2$} }
                        child{ node [] {$\dots$} }
                        child{ node [basisnode] {$\lambda_{n_2}^2$} }
                    }
                    child{ node [treenode] {$P_2$}
                        child{ node [basisnode] {$\lambda_1^2$} }
                        child{ node [] {$\dots$} }
                ...
                child{ node [treenode] {$P_1$}
                    child [sibling distance=1cm] { node [basisnode] {$\lambda_1^1$} }
                    child [sibling distance=1cm] { node [] {$\dots$} }
                    child [sibling distance=1cm] { node [basisnode] {$\lambda_{n_1}^1$} }
                };
        \end{tikzpicture}
    \end{center}
