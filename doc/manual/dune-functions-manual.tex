...
This interface is described in a separate paper~\cite{}.
...
ones like the N\'ed\'elec basis is used as well. The constructions are systematically described as tree structures.
...
\end{align*}
This is the natural basis of the space $\operatorname{span} B \otimes \operatorname{span} C$.  Its basis functions take values in $\R \otimes \R = \R^2$.
...
The simplest Taylor--Hood element is the product of $(P_2)^3 = P_2 \otimes P_2 \otimes P_2$ for the velocities with $P_1$ for the pressure.
