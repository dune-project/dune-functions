...
aber vor den Details zurück; dass z.B. statische Indizes auch dynamisch
...
the tree of global indices, and the tree of local indices.  For simplicity,
...
opt to usea fixed-size container type like \cpp{std::array}.
