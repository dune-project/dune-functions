...
\end{align}
Note that the symbol $\sqcup$ used to denote the disjoint union
        ...
        \begin{tikzpicture}[
            ...
            \node [smalltreenode] {$()$}
                child [sibling distance=70mm] { node [smalltreenode] {$( 0 )$}
                    child [sibling distance=43mm] { node [smalltreenode] {$( 0,0 )$}
                    ...
                    child [sibling distance=43mm] { node [smalltreenode] {$( 0,1 )$}
                    ...
                    child [sibling distance=43mm] { node [smalltreenode] {$( 0,2 )$}
...
then a the finite element function $(u_h,p_h)$ with velocity
$u_h$ and pressure $p_h$ defined by the coefficient vector $X$
is given by
\begin{align*}
  (u_h,p_h) &=
...
$u_h$ and $p_h$ are given by
\begin{align*}
  u_h &= \sum_{j=0}^{n_2-1} X_{(0,i,j)} (\mathbf{e}_i \otimes \lambda^{P_2}_j),
    &
