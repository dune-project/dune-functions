...
\todograeser{Should we manipulate the matrix manually or use the basis to access the entries?
The former is more efficient but also leads to code that is very specific to the indexing scheme
and matrix type while the latter works generically.}
%
...
\lstinputlisting[linerange={matrixentry_begin-matrixentry_end},
                 numbers=left]{../../examples/stokes-taylorhood.cc}
%
\todograeser{Describe \cpp{matrixEntry()} function}
