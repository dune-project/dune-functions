...
\begin{definition}
  Let $M$ a finite set and $I:M \to \mathcal{N}$. Then we call $I$ an index-map, if
  it is injective and if its range $I(M)$ is an index tree.
\end{definition}
...
The basis implementations of the previous section can be combined by building products to form new bases.
