...
public:
  ...
  {
    static_assert(Dune::Functions::Concept::isLocalFunction<F, Range(Domain), LocalContext, DerivativeTraits, false>(), "Trying to construct a LocalFunction from type that does not model the LocalFunction concept");
  }
