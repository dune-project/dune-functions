 ...
 * \tparam IMS A tag describing how global indices are build
...
Imp::PowerNodeFactoryBuilder<k, IndexMergingStrategy, SubFactoryTag> power(SubFactoryTag&& tag, const IndexMergingStrategy&)
{
  return{};
}
